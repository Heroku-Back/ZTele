...
class Config(object):
    ...
    APP_ID = int(os.environ.get("APP_ID", 27455984))
    API_HASH = os.environ.get("API_HASH") or "62d5f68ce2e9189636967120220f5755" #None
    ...
    COMMAND_HAND_LER = os.environ.get("COMMAND_HAND_LER", r".") or "."
